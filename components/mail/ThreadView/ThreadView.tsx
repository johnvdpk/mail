...
import type { FolderSummary, ThreadDetail } from "@/lib/shared/types";
    ...
    <div className={styles.wrap} key={detail.thread.id}>
      <header className={styles.head}>
        ...
        <div className={styles.headActions}>
          <button type="button" className={styles.mailAction} onClick={onReply}>
            Beantwoorden
          </button>
          {canReplyAll && (
            <button type="button" className={styles.mailAction} onClick={onReplyAll}>
              Allen
            </button>
          )}
          <button type="button" className={styles.mailAction} onClick={onForward}>
            Doorsturen
          </button>
          <button
            type="button"
